...
public class lvadapter2 extends BaseAdapter {
	...
	public lvadapter2(List<Advance_Score> aslist, Context context) {
		super();
		this.aslist = aslist;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		nametv.setText(aslist.get(position).getPlayer_name().toString());
		scoretv.setText(aslist.get(position).getScore()+"");
		return convertView;
	}
}
